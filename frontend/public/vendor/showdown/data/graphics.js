...
var avatar=Dex.resolveAvatar(side.avatar);
var noflip='';
...
noflip+"\""+ratinghtml+" style=\"background-image:url("+avatar+")\">")+("</div>"+
...
updateStatbar=function updateStatbar(pokemon,updatePrevhp,updateHp){var _pokemon$volatiles$ty;
if(!this.scene.animating)return;
if(!pokemon.isActive()){
...
}else if((_pokemon$volatiles$ty=pokemon.volatiles.typechange)!=null&&_pokemon$volatiles$ty[1]){
