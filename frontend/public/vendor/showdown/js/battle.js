...
if(this.avatar===((_this$foe=this.foe)==null?void 0:_this$foe.avatar))this.rollTrainerSprites();
}
};_proto2.
...
if(oldPokemon!=null&&oldPokemon.nature)poke.nature=oldPokemon.nature;
...
var stack=PSUtils.normalizeError(err);
if(stack){for(var _i72=0,_stack$split2=
stack.split('\n');_i72<_stack$split2.length;_i72++){var line=_stack$split2[_i72];
if(/\brun\b/.test(line)){
break;
}
this.log(['error',line]);
