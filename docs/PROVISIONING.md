...
| Piece | Identity |
|---|---|
| GCP project | `pokeprofessor`, Blaze billing |
...
Project `pokeprofessor` with Blaze billing. Enable the `run`, `cloudbuild`,
...
`web.app` address. Add `pokeprofessor.xyz` (and `www`) as a custom domain in
